    ...
    <div style={styles.page}>
      ...
      <div style={styles.leftPanel}>
        ...
        <div style={styles.leftContent}>
          ...
          <h1 style={styles.brandTitle}>Sistem Zakat</h1>
...
const styles: Record<string, React.CSSProperties> = {
  ...
  leftPanel: { width: '42%', background: 'linear-gradient(155deg, #1A4731 0%, #2D7A50 60%, #1A4731 100%)', display: 'flex', flexDirection: 'column', justifyContent: 'space-between', padding: '48px 44px', position: 'relative', overflow: 'hidden' },
  ...
  logoMark: { width: '64px', height: '64px', background: 'rgba(255,255,255,0.12)', borderRadius: '16px', display: 'flex', alignItems: 'center', justifyContent: 'center', marginBottom: '28px', border: '1px solid rgba(255,255,255,0.2)' },
  brandTitle: { fontSize: '32px', fontWeight: 700, color: '#FFFFFF', letterSpacing: '-0.5px', marginBottom: '12px' },
  brandTagline: { fontSize: '15px', color: 'rgba(255,255,255,0.7)', lineHeight: '1.6', maxWidth: '300px', marginBottom: '40px' },
  statsRow: { display: 'flex', flexDirection: 'column', gap: '12px' },
  statItem: { display: 'flex', alignItems: 'center', gap: '10px' },
  statLabel: { fontSize: '13px', fontWeight: 600, color: 'rgba(255,255,255,0.85)', letterSpacing: '0.5px', textTransform: 'uppercase' },
  ...
  rightPanel: { flex: 1, display: 'flex', alignItems: 'center', justifyContent: 'center', backgroundColor: '#F8F4ED', padding: '40px 32px' },
  formCard: { width: '100%', maxWidth: '420px', background: '#FFFFFF', borderRadius: '20px', padding: '44px 40px', boxShadow: '0 4px 24px rgba(26,71,49,0.08), 0 1px 4px rgba(26,71,49,0.06)', border: '1px solid rgba(26,71,49,0.08)' },
  formHeader: { marginBottom: '36px' },
  formEyebrow: { fontSize: '11px', fontWeight: 700, letterSpacing: '1.5px', color: '#2D7A50', textTransform: 'uppercase', marginBottom: '10px' },
  formTitle: { fontSize: '26px', fontWeight: 700, color: '#1C1917', letterSpacing: '-0.5px', marginBottom: '8px' },
  formSubtitle: { fontSize: '14px', color: '#78716C', lineHeight: '1.5' },
  ...
  input: { width: '100%', padding: '12px 14px', fontSize: '14px', color: '#1C1917', background: '#F8F4ED', border: '1.5px solid #E7E0D5', borderRadius: '10px', outline: 'none', transition: 'border-color 0.15s, box-shadow 0.15s', fontFamily: 'inherit' },
  inputFocus: { width: '100%', padding: '12px 14px', fontSize: '14px', color: '#1C1917', background: '#FFFFFF', border: '1.5px solid #2D7A50', borderRadius: '10px', outline: 'none', boxShadow: '0 0 0 3px rgba(45,122,80,0.12)', fontFamily: 'inherit' },
  ...
  footerNote: { marginTop: '24px', textAlign: 'center', fontSize: '12.5px', color: '#A8A29E' },
}
